<script>
    ...
    async function getData(){
        ...
        if(res.ok){
            ...
            immigrant = data;
			nEntradas = immigrant.length;
            console.log("Received: "+immigrant.length);
        }else{
			checkMSG = res.status;
			console.log("ERROR!")
		}
	...
	async function LoadData(){
        ...
        console.log("Loading immigrants data...");
        ...
        if (res.ok) {
            ...
            visible = true;
            nEntradas=6;
            console.log("Received " + immigrant.length + " entry data.");
            color = "success";
	...
	async function insertData(){
         ...
         console.log("Inserting immigrant data...");
         if (newData.country == "" || newData.year == null || newData.men == null || newData.women == null || newData.percentages == null ) {
            alert("Todos los campos deber ser escritos");
             ...
             const res = await fetch("/api/v2/immigrants",
			 {
             method:"POST",
	...
	async function deleteAll(){
        ...
        console.log("Deleting immigrant data...");
...
<main>
	...
	<h1 style ="text-align: center;">Inmigrantes</h1>

	{#await immigrant}
		loading immigrants data...
		{:then immigrant}
		...
		<br>
		<br>
		<h1 style ="text-align: center;">Tabla de datos de Inmigrantes</h1>
		<br>
				...
				{#each immigrant as entry}
					<tr>
						...
						<td><Button outline color="warning" on:click={function (){
							window.location.href = `/#/immigrants/${entry.country}/${entry.year}`
						}}>
							Editar
						</Button>
