<script>
	...
	import C3EmigrantGraph from "./emigrants/EmigrantsGraphC3.svelte";
	import UsoCoalStats from "./emigrants/UsoCoalStats.svelte";
	...
	const routes = {
		...
		"/emigrants-graph-C3": C3EmigrantGraph,
		"/UsoCoalStats": UsoCoalStats,
